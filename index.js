...
//highscore list
  ...
  function play(question, answer) {
    ...
    if (userAnswer.toUpperCase() === answer.toUpperCase()) {
      console.log(chalk.green.bold("\nAur yei bilkul sahi jawaab hai re baba...\n"));
